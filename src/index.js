...
p1Reader.on('reading', data => {
    ...
    if (production === 0) {
        console.error("We got a problem, production is exactly 0, consumtion, production", data.electricity.received.actual.reading, data.electricity.delivered.actual.reading)
